...
{
    class RightDefensiveMidfielderMovement : PlayerMovement
    {
        protected override void CalculateBestPosition(Vector3 homePosition, Vector3 ballPosition, int fieldWidth, int fieldLength)
        {
            ...
            switch (ballRegion)
            {
                ...
                case BallRegion.RightWing_Reg:
                    newPosition = new Vector3(HomePosition.x - 7.5f, HomePosition.y,
                                                HomePosition.z + 3);
                    return;
                ...
                case BallRegion.CenterMidfielder_Reg:
                    newPosition = newPosition = new Vector3(HomePosition.x-3, HomePosition.y,
                                            HomePosition.z + 8);
                    return;
